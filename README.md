...
This project is a full-stack e-commerce web application inspired by Amazon, built using React, Node.js, Express.js, and MongoDB. It allows users to browse and purchase products, while providing an admin panel for managing the product catalog.
...
* **Data Persistence:**  Product and user data is stored in a MongoDB database.
